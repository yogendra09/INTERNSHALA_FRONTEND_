...
// import HeroImg from "../../public/img/h"
      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2 ">
          <div className="max-w-2xl mb-8">
            <h1 className=" font-medium leading-snug tracking-tight text-gray-800 lg:text-2xl lg:leading-tight xl:text-5xl xl:leading-tight dark:text-gray-800">
              Connecting Talent to Opportunity: Your Future Starts Here!
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-lg xl:text-lg dark:text-gray-600">
              TalentLink Hub is your gateway to a world of opportunities. Our
              web application seamlessly connects students with exciting job and
              internship openings while offering HR professionals a platform to
              effortlessly create, post, and hire. Join us and bridge the gap
              between talent and potential.
            </p>
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <Image
              src="https://img.freepik.com/premium-vector/premium-flat-illustration-design-online-course_203633-7570.jpg?w=740"
              width="500"
              height="470"
